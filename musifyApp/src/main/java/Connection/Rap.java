...
public class Rap {
	...
	private void initialize() {
		...
		tableRap = new JTable();
		tableRap.setModel(database.SelectRap());
		//table.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
		tableRap.getColumnModel().getColumn(2).setMaxWidth(50);
		tableRap.setBounds(425, 69, 357, 473);
		panel.add(tableRap);
		...
		JLabel lblNewLabel = new JLabel("Rap Songs");
