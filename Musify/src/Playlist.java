...
public class Playlist {
	...
	private void initialize() {
		...
		panel_1.setBounds(250, 11, 282, 46);
		...
		panel_1_1.setBounds(10, 11, 230, 400);
		frame.getContentPane().add(panel_1_1);
		
		JLabel img = new JLabel("");
		img.setHorizontalAlignment(SwingConstants.CENTER);
		img.setBounds(10, 11, 210, 378);
		panel_1_1.add(img);
		img.setIcon(new ImageIcon("C:\\Users\\KYVOS\\eclipse-workspace\\Login\\src\\Images\\logo.png"));
		...
		panel_2.setBounds(250, 68, 282, 460);
